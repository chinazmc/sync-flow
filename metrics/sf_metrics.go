...
// sfMetrics sfFlow的Prometheus监控指标
...
func InitMetrics() {
	Metrics = new(sfMetrics)

	// DataTotal初始化Counter
	Metrics.DataTotal = prometheus.NewCounter(prometheus.CounterOpts{
		Name: common.COUNTER_SFFLOW_DATA_TOTAL_NAME,
		Help: common.COUNTER_SFFLOW_DATA_TOTAL_HELP,
	})
